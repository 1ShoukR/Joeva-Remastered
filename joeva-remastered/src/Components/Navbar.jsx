...
const Navbar = () => {
  ...
  const isLoggedInData = useSelector((state) => state.account.loggedIn)
  console.log("This is accountData Global", isLoggedInData)
  if (isLoggedInData === true) {
    return <NavBarConditional globalAccountData={globalAccountData} />
  }
  return (
